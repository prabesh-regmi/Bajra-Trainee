...
def wrong_input(user_input):
    ...
    if available_warning > 0:
        available_warning -= 1
        print(f"You have {available_warning} warnings left")
    else:
...
def get_user_input(secret_word, letters_guessed):
    ...
    while (available_guesses > 0):
        ...
        if (len(user_input) != 1):
            ...
            print(f"please Enter only onle letter: {get_guessed_word(secret_word, letters_guessed)}")
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    if is_word_guessed(secret_word, letters_guessed):
        ...
        print(f"Your total score for this game is: {get_score(secret_word, available_guesses)}")
